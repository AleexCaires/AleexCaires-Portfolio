        ...
        return(
            <footer>
                ...
                <nav className={FooterStyle.social}>
                    ...
                    <Link className={FooterStyle.icon} to="//www.facebook.com/alex.caires.98/" target="_blank" aria-label="Instagram"><FaInstagram /></Link>
                    ...
                    <Link className={FooterStyle.icon} to="//www.facebook.com/alex.caires.98/" target="_blank" aria-label=""><FaGithub /></Link>
